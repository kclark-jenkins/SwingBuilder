...
import org.krisbox.swing.builder.utils.config.FileChildren;

public class FileChildrenImpl implements FileChildren {
     ...
     * @param childKeyEvent
     */
    public FileChildrenImpl(List<String> child, List<String> childKeyEvent) {
        super();
        this.child = child;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FileChildren) == false) {
            return false;
        }
        FileChildrenImpl rhs = ((FileChildrenImpl) other);
