...
public class EditChildrenImpl implements EditChildren {
     ...
     * @param childKeyEvent
     */
    public EditChildrenImpl(List<String> child, List<String> childKeyEvent) {
        super();
        this.child = child;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EditChildren) == false) {
            return false;
        }
        EditChildrenImpl rhs = ((EditChildrenImpl) other);
