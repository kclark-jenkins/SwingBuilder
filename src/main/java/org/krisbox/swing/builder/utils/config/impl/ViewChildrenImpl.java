...
import org.krisbox.swing.builder.utils.config.ViewChildren;

public class ViewChildrenImpl implements ViewChildren {
     ...
     * @param childKeyEvent
     */
    public ViewChildrenImpl(List<String> child, List<String> childKeyEvent) {
        super();
        this.child = child;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ViewChildren) == false) {
            return false;
        }
        ViewChildrenImpl rhs = ((ViewChildrenImpl) other);
